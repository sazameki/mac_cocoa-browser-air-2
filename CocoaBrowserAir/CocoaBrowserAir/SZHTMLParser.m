...
- (BOOL)parseHTMLData:(NSData *)htmlData
{
    ...
    htmlParserCtxtPtr context = htmlCreateMemoryParserCtxt([htmlData bytes], (int)[htmlData length]);
...
static void SAXStartDocument(void *ctx)
{
    SZHTMLParser *parser = (SZHTMLParser *)ctx;
    NSObject<SZHTMLParserDelegate> *delegate = parser.delegate;
